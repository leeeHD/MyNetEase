 ...
 * @author jackytan
 */
public class BannerGalleryAdapter extends BaseNewsAdapter<NewsAds> {
	...
	@Override
	public NewsAds getItem(int position) {
		if(mDatas.size() > 0) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		NewsAds entity = getItem(position);
		if (entity != null) {
	...
	public void updateBannerGallery(List<NewsAds> liveBannerList) {
