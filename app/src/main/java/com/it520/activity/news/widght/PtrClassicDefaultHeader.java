...
import com.it520.activity.news.widght.indicator.PtrIndicator;
...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        mars = (MarsView) findViewById(R.id.mars);
        resetView();
    }
    ...
    public void onUIPositionChange(PtrFrameLayout frame, boolean isUnderTouch, byte status, PtrIndicator ptrIndicator) {
        ...
        //Log.i("hked","mOffsetToRefresh = "+mOffsetToRefresh);
...
//                }
        ...
        //crossRotateLineFromBottomUnderTouch(frame);
        int distance = currentPos-(int)(mOffsetToRefresh*0.95);

        mars.setPadingTop(distance,false);
    }
